    ...
    return (
        <>
            <div className=" text-center">
                <div className="p-2 font-bold text-lg w-fit px-10 mt-10 mx-auto" style={{ border: '2px solid #8c8c8c' }}>Shop Wise Item Sells Report</div>
                <div className="py-5 font-semibold" >09/08/2022 to 15/08/20220</div>
                <div className="relative sm:rounded-lg w-fit" style={{ border: '1px solid #8c8c8c' }}>
