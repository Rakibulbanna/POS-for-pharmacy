...
const SaleableBarcodeScanner = ({ getProduct, selectedSupplierID = 0 }) => {
  ...
  const getProducts = async (barcode) => {
    let url = `${BaseAPI}/products/sale-barcode-dynamic-search-return/${barcode}?`;
...
export default SaleableBarcodeScanner
